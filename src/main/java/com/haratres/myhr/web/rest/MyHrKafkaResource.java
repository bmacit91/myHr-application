...
@RestController
@RequestMapping("/api/my-hr-kafka")
public class MyHrKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MyHrKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MyHrKafkaResource(KafkaProperties kafkaProperties) {
